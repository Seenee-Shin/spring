...
public class Board {
	...
	public void setStatusCode(int boardStatusCode) {
		this.statusCode = boardStatusCode;
	}
	...
	public void setStatusName(String boardStatusName) {
		this.statusName = boardStatusName;
	}
